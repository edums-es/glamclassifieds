  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-border bg-card sm:flex">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <label className="mt-4 block text-sm font-semibold text-foreground">Retorno para o perfil<textarea value={moderationNote} onChange={event => setModerationNote(event.target.value)} rows={2} placeholder="Ex.: Ajuste a foto principal e reenvie para análise." className="mt-1.5 w-full rounded-xl border border-input bg-background px-3 py-2 text-sm font-normal outline-none focus:border-ring focus:ring-2 focus:ring-ring/20"/></label>
